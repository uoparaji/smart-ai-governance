...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GovernAI — AI Governance, Risk & Compliance" },
      { name: "description", content: "Centralized AI governance: register systems, assess risk, manage approvals, and prove compliance." },
    ],
